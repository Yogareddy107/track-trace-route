  ...
  return (
    <div className="relative w-full h-96 bg-gradient-to-br from-gray-100 to-orange-200 rounded-lg border overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-gray-100 via-orange-100 to-gray-200">
        ...
        <div className="absolute left-1/4 top-0 bottom-0 w-1 bg-black opacity-50"></div>
        <div className="absolute left-1/2 top-0 bottom-0 w-1 bg-black opacity-50"></div>
        <div className="absolute left-3/4 top-0 bottom-0 w-1 bg-black opacity-50"></div>
        
        {/* Current location (agent) */}
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
          <div className="relative">
            <div className="animate-ping absolute inline-flex h-8 w-8 rounded-full bg-orange-400 opacity-75"></div>
            <div className="relative inline-flex rounded-full h-6 w-6 bg-orange-600 items-center justify-center">
        ...
        <svg className="absolute inset-0 w-full h-full pointer-events-none">
          <defs>
            <pattern id="dashed" patternUnits="userSpaceOnUse" width="10" height="2">
              <rect width="5" height="2" fill="#EA580C" />
            </pattern>
          </defs>
          <path
      ...
      <div className="absolute top-4 left-4 bg-white rounded-lg shadow-md p-3 border border-orange-200">
        <div className="flex items-center space-x-2">
